...
def build_mortgage_agent(price_complectation, model: str = MODEL_MINI) -> Agent:
    mortgage_prompt = read_txt_file(MORTGAGE_PROMPT_PATH)
    mortgage_prompt = insert_style_in_prompt(mortgage_prompt)
    mortgage_prompt = insert_company_info_in_prompt(mortgage_prompt, price_complectation)
